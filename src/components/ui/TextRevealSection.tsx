...
const textContent = [
    "I'M", "PRATHAMESH", "UX", "DESIGNER", "PUNE", "DRIVEN", "CURIOSITY", "TECHNOLOGY", "BECOMING", "PART", "PEOPLE'S", "EVERYDAY", "LIVES", "FASCINATED", "SIMPLE", "INTERACTIONS", "SAVING", "TIME", "REDUCING", "FRUSTRATION", "CONNECTING", "PEOPLE", "SHAPING", "EXPERIENCES", "CURIOSITY", "DREW", "UX", "DESIGN", "UNDERSTANDING", "THOUGHTFUL", "DIGITAL", "EXPERIENCES", "SOLVING", "REAL", "PROBLEMS", "CREATING", "MEANINGFUL", "CONNECTIONS", "PEOPLE", "PRODUCTS"
];
