...
const row1 = ["Next.js", "React", "GSAP", "Three.js", "TailwindCSS", "Framer Motion"];
const row2 = ["Figma", "Photoshop", "Illustrator", "After Effects", "Rive", "Spline"];
const row3 = ["Cursor", "Linear", "Vercel", "Claude", "OpenAI", "Supabase", "Antigravity"];
