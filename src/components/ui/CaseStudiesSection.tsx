...
const CASE_STUDIES: CaseStudy[] = [
    {
        ...
        description: "A mobile personal finance platform designed to simplify budgeting, planning, and money management for young adults, while building confidence and promoting financial literacy.",
    ...
    },
    {
        ...
        title: "Nebula System",
        description: "An AI-powered social media management and predictive analytics platform designed for creators and brands. It combines trend forecasting, audience intelligence, and performance metrics into a unified workspace.",
